...
namespace polyfem::solver
{
	...
	{
		bad_dofs.clear();
		if (state_->args["solver"]["precondition_contact"])
		{
		...
		if (state_->args["solver"]["precondition_von_mises_threshold"] > 0.0)
		{
			const double thresh = state_->args["solver"]["precondition_von_mises_threshold"];
